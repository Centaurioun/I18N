...
namespace RazorSport.Pages
{
    public class SetDefaultModel : SportModel
    {
        ...
        public SetDefaultModel(SportService sportService,
                               ILogger<SetDefaultModel> logger,
                               IStringLocalizer<SetDefaultModel> localizer)
            : base(sportService)
        {
            _logger = logger;
        ...
        public IActionResult OnGet(int id) { return Page(); }
