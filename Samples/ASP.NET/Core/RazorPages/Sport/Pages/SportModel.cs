...
public class SportModel : PageModel {
  ...
  public SportModel(SportService sportService) { _sportService = sportService; }
  ...
  private string GetLanguagePart(string id) { return id.Split('-')[0]; }
  ...
  public string CookieLanguage {
    get {
      ...
      if (cookieValue != null)
        return CookieRequestCultureProvider.ParseCookieValue(cookieValue)
            .Cultures[0]
            .Value;
      else
        return "";
  ...
  public string GetLanguageName(string language) {
    ...
    switch (language) {
    case "de":
      return LanguageNames.German;
    case "en":
      return LanguageNames.English;
    case "fi":
      return LanguageNames.Finnish;
    case "fr":
      return LanguageNames.French;
    case "et":
      return LanguageNames.Estonian;
    case "ja":
      return LanguageNames.Japanese;
    case "sv":
      return LanguageNames.Swedish;
