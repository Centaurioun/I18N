...
// This model contain a sport. Because some properties of the sport need to be
// localized (e.g. name and origin) we split model into two entities: Sport and
// SpotLanguage. Sport contains language independet properties and SportLanguage
// contains language specific properties. Sport has a list of SportLanguages,
...
public enum Olympic {
    ...
    [Display(Name = "Winter")] Winter,

    [Display(Name = "Summer")] Summer
}
...
public class Sport {
    ...
    public List<SportLanguage> Languages {
        get;
        set;
    } =
        new List<SportLanguage>();
...
public class SportLanguage {
    ...
    // We don't need foreign key property but having it turns on automatic cascade
    // delete
    [JsonIgnore]
    public int SportId {
        get;
