...
// This implements the help endpoint. It returns instructions about available
// endpoints. The content has been localized and the localized strings locate in
// Controllers.HelpController.*.resx files
  ...
  public ContentResult Get() {
    ...
    return new ContentResult {
      ...
      Content =
          ...
          $"<th>{localizer["Description"]}</th>" + "</tr>" + "<tr>" +
          $"<td><a href=\"{root}sports\">sports</a></td>" +
          $"<td>{localizer["View and edit sports."]}</td>" + "</tr>" +
          "</table>"
    };
  }
}
