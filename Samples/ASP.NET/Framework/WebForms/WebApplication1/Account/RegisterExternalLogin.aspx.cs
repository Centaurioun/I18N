...
public partial class RegisterExternalLogin : System.Web.UI.Page {
  ...
  private void RedirectOnFail() {
    Response.Redirect((User.Identity.IsAuthenticated) ? "~/Account/Manage"
                                                      : "~/Account/Login");
  }
  ...
  private void CreateAndLoginUser() {
    ...
    var user =
        new ApplicationUser() { UserName = email.Text, Email = email.Text };
    ...
    if (result.Succeeded) {
      ...
      if (result.Succeeded) {
        ...
        // http://go.microsoft.com/fwlink/?LinkID=320771 var code =
        // manager.GenerateEmailConfirmationToken(user.Id); Send this link via
        // email: IdentityHelper.GetUserConfirmationRedirectUrl(code, user.Id)
