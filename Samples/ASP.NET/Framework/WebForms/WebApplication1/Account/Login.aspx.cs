...
public partial class Login : Page {
  protected void Page_Load(object sender, EventArgs e) {
    ...
    // Enable this once you have account confirmation enabled for password reset
    // functionality
  ...
  protected void LogIn(object sender, EventArgs e) {
    if (IsValid) {
      ...
      // To enable password failures to trigger lockout, change to
      // shouldLockout: true
      var result = signinManager.PasswordSignIn(
          Email.Text, Password.Text, RememberMe.Checked, shouldLockout: false);
      ...
      case SignInStatus.RequiresVerification:
        Response.Redirect(
            String.Format(
                ...
                Request.QueryString["ReturnUrl"], RememberMe.Checked),
            true);
        break;
