...
public partial class TwoFactorAuthenticationSignIn : System.Web.UI.Page {
  ...
  protected void CodeSubmit_Click(object sender, EventArgs e) {
    ...
    var result = signinManager.TwoFactorSignIn<ApplicationUser, string>(
        SelectedProvider.Value, Code.Text, isPersistent: rememberMe,
  ...
  protected void ProviderSubmit_Click(object sender, EventArgs e) {
    ...
    var user = manager.FindById(
        signinManager.GetVerifiedUserId<ApplicationUser, string>());
    if (user != null) {
      var code =
          manager.GenerateTwoFactorToken(user.Id, Providers.SelectedValue);
    }
