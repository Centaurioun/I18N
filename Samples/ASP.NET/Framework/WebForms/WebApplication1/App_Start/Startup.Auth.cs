...
public partial class Startup {
    ...
    public void ConfigureAuth(IAppBuilder app) {
        ...
        // signed in user and to use a cookie to temporarily store information about
        // a user logging in with a third party login provider Configure the sign in
        // cookie
        ...
        // Enables the application to temporarily store user information when they
        // are verifying the second factor in the two-factor authentication process.
        ...
        // such as phone or email. Once you check this option, your second step of
        // verification during the login process will be remembered on the device
        // where you logged in from. This is similar to the RememberMe option when
        // you log in.
