...
public partial class MainWindow : Window {
  ...
  private void calculateButton_Click(object sender, RoutedEventArgs e) {
    ...
    resultLabel.Content = MultiPattern.FormatMulti(
        Properties.Resources.ResultPlural, hours, minutes);
  }
  ...
  private void languageMenu_Click(object sender, RoutedEventArgs e) {
    ...
    if (SelectLanguage.Select()) {
      ...
      flagImage.Source =
          new BitmapImage(new Uri("flag_united_kingdom.png", UriKind.Relative));
      carImage.Source =
          new BitmapImage(new Uri("car_sedan_blue.png", UriKind.Relative));
    }
  }
