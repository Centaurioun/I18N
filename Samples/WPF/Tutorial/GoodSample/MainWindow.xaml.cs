...
public partial class MainWindow : Window {
  ...
  private string GetSkiCount(int count) {
    // Use MultiPattern.Format instead of String.Format whenever the placeholder
    // contains a number
  ...
  private void Window_Loaded(object sender, RoutedEventArgs e) {
    ...
    dateLabel.Content = String.Format(Properties.Resources.TodayIs,
  ...
  private void fileButton_Click(object sender, RoutedEventArgs e) {
    ...
    // This is safer than putting the whole filter into single resource string
    // because only description texts are exposed to translator
