...
public partial class MainWindow : Window {
    ObservableCollection<SportData> sportCollection =
        new ObservableCollection<SportData>();

    public MainWindow() {
        sportCollection.Add(
            new SportData { Name = Properties.Resources.SoccerName,
                            FieldPlayers = 10, Goalie = true,
                            Origin = Properties.Resources.SoccerOrigin,
                            Description = Properties.Resources.SoccerDescription
                          });

        sportCollection.Add(
            new SportData { Name = Properties.Resources.HockeyName,
                            FieldPlayers = 5, Goalie = true,
        ...
        sportCollection.Add(new SportData {
            Name = Properties.Resources.BasketballName, FieldPlayers = 5,
            Goalie = false, Origin = Properties.Resources.BasketballOrigin,
