...
public class Program {
    static void Main() {
        ...
        var service =
            ActivatorUtilities.CreateInstance<IMainService>(host.Services);
        service.Run();
    }
    ...
    /*
        static void Main()
        {
          ...
          services.AddSingleton(typeof(IStringLocalizer<Service>),
       typeof(StringLocalizer<Service>)); services.AddSingleton<IService,
       Service>();
