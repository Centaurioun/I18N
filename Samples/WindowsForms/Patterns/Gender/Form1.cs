...
public partial class Form1 : Form {
  ...
  private void Process(Gender gender, string name, Label messageLabel,
                       Label infoLabel) {
    // Update message label
    messageLabel.Text = MultiPattern.Format(
        Properties.Resources.OtherMessageGender, gender, name);

    // Update info label
    var actualGender =
        MultiPattern.GetGender(Properties.Resources.OtherMessageGender, gender);
