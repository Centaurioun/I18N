...
public partial class Form1 : Form {
  ...
  private void Process(double value, Label abbreviated, Label original) {
    ...
    abbreviated.Text = String.Format(
        template, AbbreviatedNumber.Format(Form, value, Precision));
  ...
  private void Form1_Load(object sender, EventArgs e) { UpdateValues(); }

  private void Radio_Click(object sender, EventArgs e) { UpdateValues(); }
