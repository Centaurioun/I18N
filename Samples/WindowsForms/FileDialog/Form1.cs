...
public partial class Form1 : Form {
  ...
  private void openButton1_Click(object sender, EventArgs e) {
    ...
    // Even NewTool can check the validity of localized filter string this is
    // little bit risky because translator might break the filter syntax,
  ...
  private void openButton2_Click(object sender, EventArgs e) {
    ...
    // This is safer than the above sample because only description text is
    // exposed to translator
    dialog.Filter =
        new Soluling.DialogFilter()
            .AddSupported(
                Properties.Resources
                    .AllSupportedFiles) // All supported files is first
  ...
  private void openButton4_Click(object sender, EventArgs e) {
    ...
    dialog.Filter =
        new Soluling.DialogFilter()
            ...
            .AddSupported(
                Properties.Resources
                    .AllSupportedFiles) // All supported files is second
            .Add(Properties.Resources.IniFiles, "ini") // Ini files
            .AddAll(Properties.Resources.AllFiles)     // All files is last
            .ToString();
  ...
  private void saveButton1_Click(object sender, EventArgs e) {
    ...
    dialog.Filter =
        Properties.Resources.SaveFilter; // Filter as a single string
