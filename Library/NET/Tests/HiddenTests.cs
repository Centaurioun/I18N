...
public class HiddenTests {
  ...
  [TestCategory("Hidden")]
  [TestMethod]
  public void EncodeZero() { Encode(0); }

  [TestCategory("Hidden")]
  [TestMethod]
  public void EncodeVeryShort() { Encode(1); }

  [TestCategory("Hidden")]
  [TestMethod]
  public void EncodeShort() { Encode(28); }

  [TestCategory("Hidden")]
  [TestMethod]
  public void EncodeMedium() { Encode(4151); }

  [TestCategory("Hidden")]
  [TestMethod]
  public void EncodeLong() { Encode(90123); }

  [TestCategory("Hidden")]
  [TestMethod]
  public void EncodeVeryLong() { Encode(650123); }
  ...
  public void ParseTriple() {
    ...
    var encoded = HiddenId.Inject(VALUE1, ID1) + HiddenId.Inject(VALUE2, ID2) +
                  HiddenId.Inject(VALUE3, ID3);
