...
namespace Tests
{
    ...
    public class PluralGetKindTests
    {
        ...
        {
            const string VALUE =
                @"{car, plural, one {Item \{\\\} {0} car} other {Item \{\\\} {0} cars}}";
        ...
        {
            const string VALUE =
                "{files, plural, zero {No files} one {One file} two {Two files} other {{0} files}}";
        ...
        {
            const string VALUE =
                "zero;No files;one;One file;two;Two files;other;{0} files";
        ...
        public void PluralsIcu()
        {
            const string PATTERN =
                "I have {file, plural =0 {no cars} one {{0} car} other {{0} cars}}.";
        ...
        {
            const string FORMAT =
                "zero;I have no cars;one;I have one car;other;I have {0} cars";
        ...
        {
            const string MULTI =
                "{name, gender, male {{0} will bring his} female {{0} will bring her}} {cars, plural, one {car} other {{0} cars}}.";
            Language.Id = "en";

            Same(MultiPattern.FormatMulti(
                     MULTI, new { Gender = Gender.Male, Value = "John" }, 2),
                 "John will bring his 2 cars.");

            Same(MultiPattern.FormatMulti(
                     MULTI, new { Gender = Gender.Male, Value = "Bill" }, 1),
                 "Bill will bring his car.");

            Same(MultiPattern.FormatMulti(
                     MULTI, new { Gender = Gender.Female, Value = "Jill" }, 3),
                 "Jill will bring her 3 cars.");

            Same(MultiPattern.FormatMulti(
                     MULTI, new { Gender = Gender.Female, Value = "Alma" }, 1),
        ...
        {
            const string MULTI =
                "male;{0} will bring his {1};female;{0} will bring her {1};next;one;car.;other;{0} cars.";
            Language.Id = "en";
        ...
        {
            const string VALUE =
                "I have {file, plural =0 {no cars} =1 {one car} =2 {two cars} 3..4 {few cars} ~12 {dozen cars} other {{0} cars}}.";
        ...
        {
            const string VALUE =
                "I have {file, plural <5 {a few cars} >=5 {many cars} >=10 {plenty of cars}}.";
        ...
        {
            const string GENDER =
                "{name, gender, neutral {{0} will bring the car} male {{0} will bring his car} female {{0} will bring her car}}";

            Same(MultiPattern.Format(GENDER, Gender.Male, "John"),
                 "John will bring his car");
            Same(MultiPattern.Format(GENDER, Gender.Female, "Jill"),
                 "Jill will bring her car");
            Same(MultiPattern.Format(GENDER, Gender.Neutral, "Somebody"),
                 "Somebody will bring the car");
        }
        ...
        {
            const string GENDER =
                "neutral;{0} will bring the car;male;{0} will bring his car;female;{0} will bring her car";
        ...
        {
            const string PATTERN =
                "I have {file, select car {cars} bike {bikes} ski {skis}}.";
