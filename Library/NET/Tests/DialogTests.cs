...
public class DialogTests {
  ...
  public void DialogFilter() {
    ...
    Assert.IsTrue(
        s ==
        "All files (*.*)|*.*|Supported files (*.xml;*.txt)|*.xml;*.txt|XML files (*.xml)|*.xml|Text files (*.txt)|*.txt");
    ...
    Assert.IsTrue(
        s ==
        "Supported files (*.xml;*.txt)|*.xml;*.txt|XML files (*.xml)|*.xml|Text files (*.txt)|*.txt|All files (*.*)|*.*");

    // Only all items
    s = new DialogFilter().AddAll("All files").ToString();
    ...
    // Custom placeholder
    s = new DialogFilter().Add("XML files [{0}]", "*.xml").ToString();

    Assert.IsTrue(s == "XML files [*.xml]|*.xml");

    // Another custom pattern
    s = new DialogFilter().Add("{0} files", "*.xml").ToString();
