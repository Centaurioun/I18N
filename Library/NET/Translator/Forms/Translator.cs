...
/// cref="E:Soluling.Forms.Translator.TranslateControlEvent"/> event.
/// </summary>
...
public delegate bool TranslateControlEventHandler(object sender,
                                                  Control control);

/// <summary>
/// Delegate type that is used in the <see
/// cref="E:Soluling.Forms.Translator.TranslateObjectEvent"/> event.
/// </summary>
/// <param name="sender">Sender of the event.</param>
...
public class Translator {
  ...
  /// <summary>
  /// Occurs before a control is to be translated. You can disable the
  ...
  public Translator(Form form) { TranslateForm(form); }
  ...
  private void TranslateControl(Control control, string name) {
    ...
    if ((TranslateControlEvent == null) ||
        TranslateControlEvent(this, control)) {
  ...
  static public void Translate(Form form) { new Translator(form); }
  ...
  /// <param name="includeChildren">If <b>true</b> also all child controls will
  /// be mirrored.</param>
