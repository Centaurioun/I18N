...
{
/// <summary>
/// Delegate type that is used in the <see cref="E:Soluling.Forms.Translator.TranslateControlEvent"/> event.
/// </summary>
...
/// <summary>
/// Delegate type that is used in the <see cref="E:Soluling.Forms.Translator.TranslateObjectEvent"/> event.
/// </summary>
/// <param name="sender">Sender of the event.</param>
